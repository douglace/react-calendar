...
import { MotionEventForm } from "./event-form";
...
const EventsDayBox = forwardRef<HTMLInputElement, EventsDayBoxProps>(({onClose, day}, ref) => {
    ...
    const [selectedEvent, setSelectedEvent] = useState<EventFormatedType>()
                        ...
                        <AnimatePresence>
                            {
                                ...
                                ? <MotionEventForm 
                                    ...
                                    layoutId="editForm"
                                />
                                : <motion.div layoutId="editForm" className="relative overflow-x-auto">
